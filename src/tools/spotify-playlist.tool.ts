...
import { type ErrorCode, expectOkOr204 } from '../utils/http-result.js';
    ...
    try {
      ...
      switch (parsed.action) {
        case 'list_user': {
          ...
          // Build a concise, human‑readable list of playlist names and URIs
        ...
        case 'items': {
          ...
          // Best-effort playlist name lookup
        ...
        case 'add_items': {
          ...
          // Best-effort enrichment: resolve track names and playlist name
          let playlistName: string | undefined;
          ...
          try {
            // Extract track IDs from URIs and fetch metadata (up to 50)
        ...
        case 'remove_items': {
          ...
          // Best-effort playlist name and track names
          let playlistName: string | undefined;
          try {
            const plResp = await http(
              new URL(`playlists/${parsed.playlist_id}`, base).toString(),
