    ...
    .array(
      z.object({
        ...
        position_ms: z
          ...
          .optional()
          .describe(
            "Seek or start playback from this position (milliseconds)."
          ),
        volume_percent: z
          .number()
          .min(0)
...
export const SpotifyPlaylistInputSchema = z.object({
  ...
  name: z
    .string()
    .optional()
    .describe("Playlist name (create/update_details)."),
  description: z
    .string()
    .optional()
  ...
  uris: z
    .array(z.string())
    .optional()
    .describe("Track URIs to add (add_items)."),
  tracks: z
...
export const SpotifyLibraryInputSchema = z.object({
  ...
  ids: z
    ...
    .optional()
    .describe(
      "Spotify track IDs (not URIs). Required for tracks_add/remove/contains."
    ),
});
